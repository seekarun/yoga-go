...
import { ProgressData, ApiResponse } from '@/types';
...
export async function GET(
  ...
  console.log(`[DBG][app/courses/[courseId]/progress/[savePoint]/route.ts] GET /data/app/courses/${courseId}/progress/${savePoint} called`);
