...
interface ClassicDarkPageTemplateProps extends TemplateProps {
  renderSection?: (sectionId: SectionType, content: ReactNode) => ReactNode;
}

export default function ClassicDarkPageTemplate({
  data,
  config,
  context,
  renderSection,
}: ClassicDarkPageTemplateProps) {
  ...
  return (
    <div
      className="classic-dark-template"
      style={{
        background: '#0f0f0f',
        minHeight: '100vh',
      }}
