/**
 * Expert Calendar Event CRUD Route
 * GET /data/app/expert/me/calendar/events/[eventId] - Get single event
 * PUT /data/app/expert/me/calendar/events/[eventId] - Update event
 * DELETE /data/app/expert/me/calendar/events/[eventId] - Delete event
 */
...
/**
 * GET /data/app/expert/me/calendar/events/[eventId]
...
export async function GET(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    const event = await calendarEventRepository.getCalendarEventByIdOnly(expertId, eventId);
...
/**
 * PUT /data/app/expert/me/calendar/events/[eventId]
...
export async function PUT(request: Request, { params }: RouteParams) {
  ...
  try {
    ...
    const currentEvent = await calendarEventRepository.getCalendarEventByIdOnly(expertId, eventId);
    ...
    if (body.status !== undefined) updates.status = body.status as CalendarEventStatus;
...
/**
 * DELETE /data/app/expert/me/calendar/events/[eventId]
