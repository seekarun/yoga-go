...
export default function IntegrationsPage() {
  ...
  // }>({ connected: false, email: null, locationName: null });
  ...
  useEffect(() => {
    ...
    //   .catch((err) =>
    //     console.error(
    //       "[DBG][settings] Failed to fetch Google Business status:",
    //       err,
    //     ),
    //   );
  }, []);
  ...
  const integrations = [
    ...
    //   description: googleBusinessStatus.connected
    //     ? `Connected — ${googleBusinessStatus.locationName || googleBusinessStatus.email}`
    //     : "View and reply to your Google Reviews",
    //   connected: googleBusinessStatus.connected,
    //   statusText: googleBusinessStatus.connected
    //     ? "Connected"
    //     : "Not connected",
