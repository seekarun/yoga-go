 ...
 * @param role - User role ('host' or 'guest')
...
export async function generateAuthToken(
  ...
  console.log(
    "[DBG][100ms-auth] Generating auth token for room:",
    roomId,
    "role:",
    role,
  );
...
/**
 * Determine the role for a user joining a meeting
 *
 * @param isHost - Whether the user is the host (tenant owner)
 */
export function determineRole(isHost: boolean): HmsRole {
