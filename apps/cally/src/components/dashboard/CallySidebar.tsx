...
export default function CallySidebar({ expertId }: CallySidebarProps) {
  ...
  const toggleCollapsed = () => {
    ...
    localStorage.setItem("cally-sidebar-collapsed", String(newState));
  ...
  const menuItems: MenuItem[] = [
    ...
    // Surveys menu item hidden — routes and code kept intact
    // {
    //   id: "surveys",
    //   label: "Surveys",
    //   href: `/srv/${expertId}/surveys`,
    //   icon: ( ... ),
    // },
    {
      id: "forms",
      label: "Forms",
      href: `/srv/${expertId}/forms`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
    ...
    // TODO: Uncomment when Meta Business account is set up
    // {
    //   id: "ads",
    //   label: "Ad Campaigns",
    ...
    },
    {
      id: "ai-assistant",
      label: "AI Assistant",
      href: `/srv/${expertId}/ai-assistant`,
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
  ...
  const isActive = (href: string) => {
    ...
    // If another menu item has a longer href that also matches, prefer that one
