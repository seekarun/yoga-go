...
/**
 * HmsVideoRoom Component for Cally
 *
 * Video conferencing room using 100ms SDK
 * Simplified version - handles video/audio toggle, peer grid, and leave functionality
 */
  ...
  if (isJoining) {
    return (
      ...
      >
        ...
        />
        <p style={{ color: "#fff", marginTop: "16px" }}>Joining meeting...</p>
