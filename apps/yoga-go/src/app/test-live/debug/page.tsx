...
export default function DebugAuthPage() {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Debug page displays raw API response properties
        ...
        <>
          ...
          >
            ...
            {authData?.role !== 'expert' && (
              ...
              >
                <strong>⚠️ Issue:</strong> Your user role is not &quot;expert&quot;. You need to be
                an expert to create live sessions.
              </div>
            )}
          </div>
