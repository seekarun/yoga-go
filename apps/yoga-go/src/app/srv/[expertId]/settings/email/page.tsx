        ...
        {hasByodEmail && (
          ...
          >
            ...
            <p style={{ color: '#666', marginBottom: '16px' }}>
              Emails to customers on your custom domain ({tenant?.primaryDomain}) will be sent from
              this address. This provides a professional, branded experience.
            </p>
        ...
        {!hasByodEmail && tenant?.primaryDomain && tenant?.status === 'active' && (
          ...
          >
            ...
            <p style={{ color: '#713f12', marginBottom: '16px' }}>
              You have a custom domain ({tenant.primaryDomain}) configured. You can set up email to
              send transactional emails from your own domain for a more professional experience.
            </p>
            <Link
              href={`/srv/${expertId}/settings/domain`}
              style={{
