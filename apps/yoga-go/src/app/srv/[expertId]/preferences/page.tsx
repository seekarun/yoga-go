            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '13px', color: '#0c4a6e', marginTop: '4px' }}>
                  Learners from other countries will see approximate prices in their local currency,
                  but will be charged in your preferred currency. Exchange rate conversions are
