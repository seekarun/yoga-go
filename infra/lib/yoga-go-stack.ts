    ...
    const appClient = userPool.addClient("YogaGoWebClient", {
      ...
      oAuth: {
        ...
        callbackUrls: [
          ...
          "https://yoga.vercel.app/api/auth/callback/cognito",
          ...
          "https://yoga.vercel.app/api/auth/google/callback",
          ...
          "https://yoga.vercel.app/api/auth/facebook/callback",
        ],
        logoutUrls: [
          "http://localhost:3111",
          `https://${appDomain}`,
          `https://www.${appDomain}`,
          "https://yoga.vercel.app",
        ],
      },
